...
# --- PAGE 3: FACILITY & PROCESS ENGINEERING ---
    ...
    # TAB 1: WORKFLOW WITH PDF DOWNLOAD
    with tab1:
    ...
    # TAB 2: FACILITY LAYOUT WITH PDF DOWNLOAD
    with tab2:
        ...
        # Generate PDF Bytes using Kaleido and create Download Button
        pdf_bytes_layout = fig_layout.to_image(format="pdf")
        st.download_button(
            label="📄 Download Schematic Layout as PDF",
            data=pdf_bytes_layout,
            file_name="Facility_Layout_Sadat_Plant.pdf",
            mime="application/pdf"
        )
